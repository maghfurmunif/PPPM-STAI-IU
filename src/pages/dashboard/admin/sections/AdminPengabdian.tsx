            ...
            <AnimatePresence mode="wait">
               {selectedReg ? (
                 <motion.div 
                   ...
                   className="space-y-8"
                 >
                   <div className="card bg-slate-50 text-slate-900 p-10 overflow-hidden relative shadow-2xl border-none">
                   ...
                   <div className="animate-in fade-in zoom-in duration-500">
                      ...
                      {selectedReg.status === 'LOGBOOK' && (
                        <div className="card p-20 text-center bg-slate-50 text-slate-900 border-none shadow-2xl relative overflow-hidden">
                           ...
                           <p className="text-slate-500 font-bold uppercase tracking-[0.3em] text-[10px] mt-4 italic max-w-sm mx-auto leading-relaxed">Dosen is currently executing the community outreach program and documenting tactical reports.</p>
                      ...
                      {selectedReg.status === 'COMPLETED' && (
                        <div className="space-y-10 shadow-sm rounded-3xl">
                           <div className="card p-20 text-center bg-slate-100 border-none shadow-inner relative overflow-hidden flex flex-col items-center">
                              ...
                              <p className="text-slate-500 font-bold uppercase tracking-[0.3em] text-[10px] mt-6 italic">This project has been successfully archived in the institutional database.</p>
                 ...
                 <div className="card h-[700px] flex flex-col items-center justify-center text-center p-20 border-dashed border-2 bg-slate-50/50">
                    ...
                    <h3 className="text-2xl font-black text-slate-500 uppercase tracking-[0.4em] italic leading-tight uppercase">Awaiting Outreach <br/> Selection</h3>
                    <p className="text-slate-500 text-xs font-bold mt-6 max-w-xs leading-relaxed">Please select a community service registration from the directory to start the audit process.</p>
                 </div>
               )}
            </AnimatePresence>
        </div>
    ...
    <div className="card p-12 bg-white shadow-2xl space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700 rounded-[50px]">
       <div className="flex items-center justify-between border-b border-slate-100 pb-8">
          <div className="space-y-1">
             ...
             <p className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.3em] mt-2 italic pl-1">Reviewing mission assignment letters and proposals</p>
          </div>
          ...
          <div className="p-8 bg-slate-50 rounded-[40px] border border-slate-100 space-y-8 group hover:bg-slate-100 transition-colors">
             <div className="flex items-center space-x-5">
                ...
                <div>
                   ...
                   <p className="text-[10px] font-black text-slate-500 mt-2 uppercase tracking-widest italic">Surat_Tugas.PDF</p>
                </div>
             </div>
             <button 
          ...
          <div className="p-8 bg-slate-50 rounded-[40px] border border-slate-100 space-y-8 group hover:bg-slate-100 transition-colors">
             <div className="flex items-center space-x-5">
                ...
                <div>
                   ...
                   <p className="text-[10px] font-black text-slate-500 mt-2 uppercase tracking-widest italic">Proposal_Service.PDF</p>
                </div>
             </div>
             <button 
