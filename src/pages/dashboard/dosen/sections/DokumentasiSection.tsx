      ...
      {showAdd && (
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="card space-y-6">
           <div className="flex items-center justify-between border-b border-slate-50 pb-4">
              ...
              <button onClick={() => setShowAdd(false)} className="text-slate-500 hover:text-red-500 transition-colors">Batal</button>
           </div>
           
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                 <div className="space-y-1">
                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Jenis Karya</label>
                 ...
                 <div className="space-y-1">
                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Judul Karya</label>
                    <input className="input-field" placeholder="Masukkan judul lengkap..." />
                 </div>
                 <div className="grid grid-cols-2 gap-4">
                    <div className="space-y-1">
                       <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Tanggal Publikasi</label>
                       <input type="date" className="input-field" />
                    </div>
                    <div className="space-y-1">
                       <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">ISBN / ISSN</label>
              ...
              <div className="space-y-4">
                 <div className="space-y-1">
                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Penulis Tambahan (Jika Ada)</label>
                    <input className="input-field" placeholder="Pisahkan dengan koma..." />
                 </div>
                 <div className="space-y-1">
                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Penerbit / Nama Jurnal</label>
                    <input className="input-field" placeholder="Nama instansi/jurnal..." />
                 </div>
                 <div className="space-y-1">
                    <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">Platform Penyimpanan</label>
                    <select className="input-field">
           ...
           <div className="space-y-2">
              <label className="text-[10px] font-black text-slate-500 uppercase tracking-widest">File Karya (PDF)</label>
              <div className="p-10 border-2 border-dashed border-slate-100 rounded-2xl flex flex-col items-center justify-center text-slate-500">
                 <FileUp size={32} />
           ...
           {docs.map((doc, i) => (
             ...
             >
                <div className="flex items-center justify-between mb-4">
                   ...
                   <button className="text-slate-500 hover:text-primary transition-colors"><ExternalLink size={16} /></button>
                </div>
